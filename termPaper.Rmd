...
\
Here, \textbf{k} denotes the latent factor size. Let $a_4$ denote the 4$^{\text{th}}$ row of \textbf{A} and $b_i$ denote the i$^{\text{th}}$ row of \textbf{B}.
\
