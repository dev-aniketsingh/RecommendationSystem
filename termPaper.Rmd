...
\maketitle
\section{Abstract}
Recommendation System have become a part of our life, we see them everywhere without realizing that a recommendation algorithm is being used behind them. We get recommendations while watching videos, buying any product, reading news on websites, booking flights/hotels. All of these are possible with Recommendation Systems. We are using Matrix Factorization method to implement our recommendations system. We used both user and item based recommendation systems. 
\clearpage
